        ...
        return (
            <Scene physics=''>
                ...
                <DynamicBox position={{x: -4, y: 3, z: -3}}
                    ...
                    <Entity text={{value: 'Hello, A-Frame React!', align: 'center', fontSize: 30}}
                ...
                <StaticBox id="box"
                    ...
                    <StaticBox animation__scale={{property: 'scale', dir: 'alternate', dur: 100, loop: true, to: '1 1 1'}}
